# LogiHub — Product Flow Diagram (Detailed)
...
flowchart TD
    ...
    classDef contract fill:#1a1a2e,stroke:#e74c3c,color:#fff,rx:8
...
| 🟣 Purple | Solvers | 3 mathematical optimizers (run in parallel) |
