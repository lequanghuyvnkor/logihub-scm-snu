...
def main():
    ...
    top_lanes = [{"origin_region": r1, "destination_region": r2, "product_family": "FMCG_Packaged", "volume": round(np.random.uniform(500, 2000), 2), "unit": "ton", "share_pct": round(np.random.uniform(1, 10), 2)} for r1, r2 in zip(regions[:5], regions[5:10])]
    ...
    allocations = [{"scenario_id": "S3", "region_name": r, "hub_id": np.random.choice(hubs), "product_family": "Durables_Electronics", "volume": 100, "unit": "ton", "allocation_share_pct": 100.0} for r in regions]
    ...
    # so the file exists for downstream code; run seasonal_playbook_generator.py
    # afterwards to produce the real playbook from monthly_demand + diagnosis CSVs.
    playbook = [{
        "event_id": "E1",
        "event_name": "M02-M03_Durables_Electronics_peak_window",
        "months": ["2023-02", "2023-03"],
        "affected_product_families": ["Durables_Electronics"],
        "affected_hubs": ["GG_METRO"],
        "risk": "Capacity overflow at affected hubs during M02-M03 high-velocity durable goods and electronics launch wave",
        "recommended_actions": [
    ...
    master_json = {
        ...
        "product_segmentation": {
            ...
            "rules_applied": 5,
            "distribution": [{"product_family": p, "volume": 10000, "unit": "ton", "share_pct": 20.0} for p in product_families],
        ...
        "diagnosis": {
            ...
            "underused_hubs": [],
            "high_cost_lanes": [{"lane_id": "Seoul-Busan", "origin_region": "Seoul", "destination_region": "Busan", "product_family": "FMCG_Packaged", "monthly_volume": 1000, "unit": "ton", "distance_km": 320, "cost": 48000, "currency": "USD", "cost_share_pct": 12.5, "driver": "Distance", "recommended_action": "Open Southern Hub"}],
        ...
        "recommended_network": {
            ...
            "recommended_hubs": [{"hub_id": "GG_METRO", "hub_name": "Gyeonggi Hub", "region_name": "Gyeonggi", "role": "metro_fulfillment", "lat": 37.5, "lon": 127.1, "served_regions": ["Seoul", "Gyeonggi"], "served_product_families": ["Durables_Electronics"], "reason_selected": "High demand density"}],
