    ...
    <div className="page">
      <div className="page-head">
        ...
        <div className="page-sub">
          Final forecast output generated by applying physical/legal constraints (Filter 1) 
          and seasonal multipliers (Filter 2) to base demand data.
        </div>
      </div>
      ...
      <window.KPIStrip>
        ...
        <window.KPI label="Active Events" value={window.EVENTS.length} foot="Seasonal multipliers applied"/>
      </window.KPIStrip>
    ...
    <div className="page">
      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          ...
          {hasLiveScenarios && <span className="badge healthy" style={{ fontSize: 10 }}><span className="dot"/>Live results</span>}
        </div>
      ...
      {!hasLiveScenarios && !isRunning9 && (
        <div style={{ padding: "40px 20px", textAlign: "center", color: "var(--ink-3)" }}>
          Click "Run 9 scenarios" to evaluate S0–S8 against your network.
        </div>
      )}

      {hasLiveScenarios && <NineScenariosView data={window.API_STATE.liveScenarios}/>}
    </div>
  );
}
